# The First 90 Days – Chapter Outline
...
### Transition Scenarios Table

| Transition Scenario | Applies? | Difficulty (1-10) |
| ------------------- | -------- | ----------------- |
| Moving to a new industry or profession | No | N/A |
| Joining a new company | Yes | 7 |
| Moving to a new unit or group in the same company | No | N/A |
| Being promoted to a higher level | Yes | 5 |
| Leading former peers (assuming you have been promoted) | No | N/A |
| Moving from one function to another (e.g., sales to marketing) | No | N/A |
| Taking on a cross-functional leadership role for the first time | No | N/A |
| Moving geographically | Yes-ish | 7 |
| Entering a new national or ethnic culture | Yes | 6 |
| Having to do two jobs at the same time (finishing old role while starting new one) | No | N/A |
| Taking on a newly created role (as opposed to an existing role) | Yes | 8 |
| Entering an organization in which major change already is going on | No? | N/A |
| Totals | | 33 |

## 1. Prepare Yourself

### Prep checklist from audiobook

- [ ] New org: how to orient with the business, identify with key stakeholders, key expectations, adapt to new culture (keep or change culture)
- [ ] What has made me successful?  Is this enough or do I need to develop new skills?
- [ ] Are there aspects that are critical but I don't want to focus on?
- [ ] How to make mental leap into new position?  Other activities?

### Onboarding Checklists Table 1-1

Business orientation checklist

- [x] As early as possible, get access to publicly available information about financials, products, strategy, and brands.
...
- [x] During recruiting, ask questions about the organization’s culture.
...
### Assessment of Problem Preferences Table 1-2
...
### Preferences for problems and functions Table 1-3

| | Technical | Political | Cultural | Total |
| - | ------- | --------- | -------- | ----- |
| Human resources | 2 | 8 | 6 | 16 |
| Finance | 7 | 6 | 6 | 19 |
| Marketing | 8 | 6 | 5 | 19 |
| Operations | 10 | 6 | 8 | 24 |
| Research and development | 7 | 8 | 8 | 23 |
| Total | 34 | 33 | 33 | |
...
- Questions about the past?
  - Performance
    ...
    - How were goals set?
    - Were they insufficiently or overly ambitious?
  ...
  - Root Causes
    ...
    - Do the primary issues reside in the organization’s strategy? Its structure? Its technical capabilities? Its culture? Its politics?
  - History of Change
...
- Questions about the present?
  ...
  - People
    ...
    - Who has influence, and why?
      - **Soundharya likely, she got the web version to 510k, got promotoed and created my position.**
  - Processes
  ...
  - Land Mines
    - What lurking surprises could detonate and push you offtrack?
      - **Possibly commitments on home software 510k.**
    - What potentially damaging cultural or political missteps must you avoid?
  - Early Wins
    - In what areas (people, relationships, processes, orproducts) can you achieve some early wins?
      - **New patient circuit software code, documentation, test and release.**
...
In contrast, realignments (and 
sustaining-success assignments) are more 
ready-aim-fire situations. Turning around 
a failing business requires the new leader 
to cut it down to a defensible core fast 
and then begin to build it back up. This 
painful process, if successful, leaves the 
business in a sustaining-success situation. 
If efforts to turn around the business fail, 
the result often is shutdown or divestiture.

In realignments and sustaining-success 
situations, in contrast, you enter 
organizations that have significant 
strengths but also serious constraints 
on what you can and cannot do. Fortunately, 
in these two situations you typically have 
some time before you need to make major 
calls. This is good, because you must learn 
a lot about the culture and politics and 
begin building supportive coalitions. 
Because of internal complacency, erosion 
of key capabilities, or external challenges, 
successful businesses tend to drift 
toward trouble. In a realignment, your 
challenge is to revitalize a unit, product, 
process, or project that has been drifting 
into danger. The clouds are gathering on 
the horizon, but the storm has not yet 
broken—and many people may not even see 
the clouds. The biggest challenge often is 
to create a sense of urgency. There may be 
a lot of denial; the leader needs to open 
people’s eyes to the fact that a problem 
actually exists.

Want to understand the Polarion situation and
